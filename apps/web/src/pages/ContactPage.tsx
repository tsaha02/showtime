  ...
  return (
    <Box sx={{ maxWidth: 560 }}>
      ...
      <Alert severity="info" sx={{ mb: 3 }}>
        This is a demo project — no live support desk is staffed, but the form below is wired for
        real (client-side validation and all), it just doesn't send anywhere.
      </Alert>
